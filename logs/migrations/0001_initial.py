    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('today_condition', models.CharField(default='좋음', max_length=10)),
                ('illness', models.CharField(default='없음', max_length=20)),
                ('illness_range', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(limit_value=1), django.core.validators.MaxValueValidator(limit_value=10)])),
